...
export FZF_DEFAULT_OPTS="--style minimal --color fg:8,hl:4,current-hl:0,current-fg:0,current-bg:4,pointer:4,info:4,prompt:4,border:0 --padding 1,2 --border none"
